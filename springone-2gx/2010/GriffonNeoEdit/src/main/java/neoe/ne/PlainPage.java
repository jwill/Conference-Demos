...
public class PlainPage {
	...
	class Paint {
		...
		Dimension dim;
		Font font = new Font("Droid Sans Mono", Font.PLAIN, 18);
		int gutterWidth = 40;
		int lineGap = 5;
		int lineHeight = 15;
		boolean noise = false;
		...
		int drawStringLine(Graphics2D g2, String s, int x, int y, int lineno) {
	...
	static final String REV = "$Rev: 117 $";
